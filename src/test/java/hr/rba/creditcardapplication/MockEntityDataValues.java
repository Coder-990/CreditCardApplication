...
public class MockEntityDataValues {
    ...
    public static final String OIB_4 = "96585474444";
    public static final Person PERSON_1 = new Person(1L, OIB_1, "Pero", "Peric", new File(1L, ACTIVE));
    public static final Person PERSON_2 = new Person(2L, OIB_2, "Nino", "Ninic", new File(2L, ACTIVE));
    public static final Person PERSON_3 = new Person(3L, OIB_3, "Ivo", "Ivic", new File(3L, ACTIVE));
